...
This is pretty much the same as the previous level, except the pin field is now changed to a password field with text, so we'll need to terminate the quotes.
